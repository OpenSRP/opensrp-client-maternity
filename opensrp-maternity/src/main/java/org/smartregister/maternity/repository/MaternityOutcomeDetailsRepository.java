...
public class MaternityOutcomeDetailsRepository extends MaternityDetailsRepository {
    ...
    public static void createTable(@NonNull SQLiteDatabase database) {
        ...
        for (MaternityDetails.Property column: MaternityDetails.Property.values()) {
    ...
    private static String getTableNameStatic() {
        return MaternityDbConstants.Table.MATERNITY_DETAILS;
    }
