...
import org.smartregister.maternity.utils.OpdDbConstants.Column.OpdDetails;
...
public class OpdDetailsRepository extends BaseRepository implements OpdDetailsDao {
    ...
    @NonNull
    public ContentValues createValuesFor(@NonNull org.smartregister.maternity.pojos.OpdDetails opdDetails) {
    ...
    @Override
    public boolean saveOrUpdate(@NonNull org.smartregister.maternity.pojos.OpdDetails opdDetails) {
    ...
    @Nullable
    @Override
    public org.smartregister.maternity.pojos.OpdDetails findOne(@NonNull org.smartregister.maternity.pojos.OpdDetails opdDetails) {
        org.smartregister.maternity.pojos.OpdDetails details = null;
        if (opdDetails.getCurrentVisitId() != null && opdDetails.getBaseEntityId() != null) {
            ...
            if (cursor.moveToNext()) {
                details = new org.smartregister.maternity.pojos.OpdDetails();
    ...
    @Override
    public boolean delete(org.smartregister.maternity.pojos.OpdDetails opdDetails) {
        throw new NotImplementedException("Not Implemented");
    }

    @Override
    public List<org.smartregister.maternity.pojos.OpdDetails> findAll() {
        throw new NotImplementedException("Not Implemented");
    }
}
