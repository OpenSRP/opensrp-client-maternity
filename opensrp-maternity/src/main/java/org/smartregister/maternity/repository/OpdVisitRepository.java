...
public class OpdVisitRepository extends BaseRepository implements OpdVisitDao {
    ...
    public ContentValues createValuesFor(@NonNull org.smartregister.maternity.pojos.OpdVisit visit) {
    ...
    @NonNull
    protected org.smartregister.maternity.pojos.OpdVisit getVisitResult(@NonNull Cursor cursor) {
        org.smartregister.maternity.pojos.OpdVisit visit = new org.smartregister.maternity.pojos.OpdVisit();
    ...
    @Nullable
    @Override
    public org.smartregister.maternity.pojos.OpdVisit getLatestVisit(@NonNull String clientBaseEntityId) {

        Cursor mCursor = null;
        org.smartregister.maternity.pojos.OpdVisit visit = null;
        try {
    ...
    public boolean addVisit(@NonNull org.smartregister.maternity.pojos.OpdVisit visit) {
