...
public class OpdCheckInRepository extends BaseRepository implements OpdCheckInDao {
    ...
    public ContentValues createValuesFor(@NonNull org.smartregister.maternity.pojos.OpdCheckIn checkIn) {
    ...
    @Nullable
    @Override
    public org.smartregister.maternity.pojos.OpdCheckIn getLatestCheckIn(@NonNull String clientBaseEntityId) {
        Cursor mCursor = null;
    ...
    @Nullable
    @Override
    public org.smartregister.maternity.pojos.OpdCheckIn getCheckInByVisit(@NonNull String visitId) {
        Cursor mCursor = null;
        org.smartregister.maternity.pojos.OpdCheckIn checkIn = null;
        try {
            SQLiteDatabase db = getWritableDatabase();
    ...
    @NonNull
    protected org.smartregister.maternity.pojos.OpdCheckIn getCheckInResult(@NonNull Cursor cursor) {
        org.smartregister.maternity.pojos.OpdCheckIn checkIn = new org.smartregister.maternity.pojos.OpdCheckIn();
    ...
    @Override
    public boolean addCheckIn(@NonNull org.smartregister.maternity.pojos.OpdCheckIn checkIn) throws SQLiteException {
