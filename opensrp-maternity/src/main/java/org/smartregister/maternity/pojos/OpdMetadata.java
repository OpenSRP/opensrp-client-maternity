...
public class OpdMetadata {
    ...
    private LocationHierarchyProvider locationHierarchyProvider;
    ...
    public OpdMetadata(@NonNull String opdRegistrationFormName, @NonNull String tableName, @NonNull String registerEventType, @NonNull String updateEventType,
                       @NonNull String config, @NonNull Class opdFormActivity, @Nullable Class profileActivity, @NonNull LocationHierarchyProvider locationHierarchyProvider, boolean formWizardValidateRequiredFieldsBefore) {
        ...
        this.locationHierarchyProvider = locationHierarchyProvider;
    ...
    public ArrayList<String> getLocationLevels() {
        if (locationLevels == null) {
            locationLevels = locationHierarchyProvider.getLocationLevels();
        }
    ...
    public ArrayList<String> getHealthFacilityLevels() {
        if (healthFacilityLevels == null) {
            healthFacilityLevels = locationHierarchyProvider.getHealthFacilityLevels();
        }
