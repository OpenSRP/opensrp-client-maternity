...
public class BaseMaternityFormFragment extends JsonWizardFormFragment implements ClientLookUpListAdapter.ClickListener {
    ...
    private MaternityFormFragmentPresenter presenter;

    public static JsonWizardFormFragment getFormFragment(String stepName) {
        BaseMaternityFormFragment jsonFormFragment = new BaseMaternityFormFragment();
    ...
    public MaternityFormFragmentPresenter getPresenter() {
        return presenter;
    }
    ...
    protected void startActivityOnLookUp(@NonNull CommonPersonObjectClient client) {
        ...
        client.getColumnmaps().put(MaternityConstants.ColumnMapKey.REGISTER_ID, opensrpId);
        client.getDetails().put(MaternityConstants.ColumnMapKey.REGISTER_ID, opensrpId);

        intent.putExtra(MaternityConstants.IntentKey.CLIENT_OBJECT, client);
    ...
    protected JsonWizardFormFragmentPresenter createPresenter() {
        presenter = new MaternityFormFragmentPresenter(this, MaternityFormInteractor.getInstance());
        return presenter;
    }
}
