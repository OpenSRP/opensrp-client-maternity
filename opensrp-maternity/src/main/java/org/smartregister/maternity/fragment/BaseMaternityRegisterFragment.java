...
import org.smartregister.maternity.dialog.NoMatchDialogFragment;
import org.smartregister.maternity.model.MaternityRegisterFragmentModel;
...
public abstract class BaseMaternityRegisterFragment extends BaseRegisterFragment implements MaternityRegisterFragmentContract.View {
    ...
    public void setupViews(View view) {
        ...
        searchBarLayout.setPadding(searchBarLayout.getPaddingLeft()
                ...
                , (int) MaternityUtils.convertDpToPixel(10, getActivity()));
    ...
    protected void initializePresenter() {
        ...
        presenter = new MaternityRegisterFragmentPresenter(this, new MaternityRegisterFragmentModel());
    }
    ...
    public void initializeAdapter() {
        MaternityRegisterProvider childRegisterProvider = new MaternityRegisterProvider(getActivity(), registerActionHandler, paginationViewHandler);
    ...
    @Override
    public MaternityRegisterFragmentContract.Presenter presenter() {
        return (MaternityRegisterFragmentContract.Presenter) presenter;
    }
